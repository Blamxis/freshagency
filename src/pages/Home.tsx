  ...
  return (
    <div className="pt-16">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">{t('home.services.title')}</h2>
            <p className="text-lg sm:text-xl text-muted-foreground">{t('home.services.subtitle')}</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {services.map((service, index) => (
              <div key={index} className="p-6 bg-card rounded-xl border border-border hover:border-tiktok-red/50 transition-colors">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">{t('home.eligibility.title')}</h2>
            <p className="text-lg sm:text-xl text-muted-foreground">{t('home.eligibility.subtitle')}</p>
          </div>

          <div className="max-w-3xl mx-auto">
            <div className="bg-card rounded-xl p-6 sm:p-8 border border-border">
              <ul className="space-y-4">
                {t('home.eligibility.criteria', { returnObjects: true }).map((criterion: string, index: number) => (
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">{t('home.certifiedStreamers.title')}</h2>
            <p className="text-lg sm:text-xl text-muted-foreground">{t('home.certifiedStreamers.subtitle')}</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {certifiedStreamers.map((streamer, index) => (
              <div key={index} className="bg-card rounded-xl overflow-hidden border border-border hover:border-tiktok-red/50 transition-colors">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center">
                      <h3 className="text-lg sm:text-xl font-semibold text-foreground">{streamer.name}</h3>
                      {streamer.certified && (
